...
sizes = [35, 65, 67, 97, 99, 129, 131, 161, 163, 193, 195, 225, 227, 257, 259, 289, 291, 321, 323, 353, 355, 385, 387, 417, 419, 449, 451, 481, 483, 513, 515, 545, 547, 577, 579, 609, 611, 641, 643, 673, 675, 705, 707, 737, 739, 769, 771, 801, 803, 833, 835, 865, 867, 897, 899, 929, 931, 961, 963, 993, 995, 1025, 1027, 1057, 1059, 1089, 1091,
         1121, 1123, 1153, 1155, 1185, 1187, 1217, 1219, 1249, 1251, 1281, 1283, 1313, 1315, 1345, 1347, 1377, 1379, 1409, 1411, 1441, 1443, 1473, 1475, 1505, 1507, 1537, 1539, 1569, 1571, 1601, 1603, 1633, 1635, 1665, 1667, 1697, 1699, 1729, 1731, 1761, 1763, 1793, 1795, 1825, 1827, 1857, 1859, 1889, 1891, 1921, 1923, 1953, 1955, 1985, 1987, 2017]
sizes = [131, 163, 195, 227, 259, 291, 323, 355, 387, 419, 451, 483, 515, 547, 579, 611, 643, 675, 707, 739, 771, 803, 835,
         867, 899, 931, 963, 995, 1027, 1059, 1091, 1123, 1155, 1187, 1219, 1251, 1283, 1315, 1347, 1379, 1411, 1443, 1475, 1507]
sizes = [227, 259, 291, 323, 355, 387, 419, 451, 483, 515, 547, 579, 611, 643, 675, 707, 739, 771, 803, 835, 867,
         899, 931, 963, 995, 1027, 1059, 1091, 1123, 1155, 1187, 1219, 1251, 1283, 1315, 1347, 1379, 1411, 1443, 1475, 1507]
...
def run_fcntest(inputdir, outputdir, gpudevice):
    ...
    filelist = [os.path.basename(os.path.normpath(x)) for x in glob.glob(
        data_root + inputdir + '*' + image_typ)]
    done_list = [os.path.basename(os.path.normpath(x))
    ...
    for filename in filelist:
        ...
        print out.shape
        imsave(results_root + outputdir +
               inputdir + filename[:-3] + 'png', out)
